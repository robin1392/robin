...
namespace Photon
{
    public static class PhotonTaskCallback
    {
        /// <summary>
        ...
        private static PhotonCallbacksBridge _instance;

        public static PhotonCallbacksBridge GetBridge()
        {
            if (_instance != null) return _instance;

            var gameObject = new GameObject {name = "PhotonTaskCallback"};
            Object.DontDestroyOnLoad(gameObject);
            _instance = gameObject.AddComponent<PhotonCallbacksBridge>();
            return _instance;
        }
