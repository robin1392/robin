...
{
    public sealed class PhotonCallbacksBridge : MonoBehaviour, IConnectionCallbacks, IMatchmakingCallbacks, IInRoomCallbacks
    {
        #region OnConnected
        ...
        public void OnPlayerEnteredRoom(Player newPlayer)
        {
            ...
            Debug.Log($"OnPlayerEnteredRoom {newPlayer.NickName} {newPlayer.UserId}");
        }
