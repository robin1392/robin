		...
		private void UpdateServiceContainer()
		{
			if (enabled && gameObject.activeSelf)
			{
				...
				if (checkWireframe && wfCamera == null)
				{
					...
					if (wfShader == null)
					{
						Debug.LogError(FinalLogPrefix + "can't find '" + WireframeShaderName + "' shader!\nPlease make sure you have it included at the ACTk Settings widow.", this);
					...
					else
					{
						...
						else
						{
							...
							{
								shaderTexture = new Texture2D(ShaderTextureSize, ShaderTextureSize, TextureFormat.RGB24, false, true);
							...
							if (targetTexture == null)
							{
								targetTexture = new Texture2D(RenderTextureSize, RenderTextureSize, TextureFormat.RGB24, false, true);
