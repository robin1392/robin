...
namespace Service.Net
{
    public class NetServer : NetBase
    {
                ...
                case ENetProtocol.AUTH_SESSION_REQ:
                    {
                        ...
                        {
                            // 세션 인증 실패
                            clientSession.SendNetAuthSessionAck(gameSessionId);
                            break;
                        }
        ...
        private bool CheckDuplicatedClientSession(ClientSession clientSession)
        {
            ...
            if (GetAuthedClientSession(clientSession.Id, out duplicatedSession) == false)
            {
                return false;
            }
            ...
            duplicatedSession.SendNetDisconnectNotify();
