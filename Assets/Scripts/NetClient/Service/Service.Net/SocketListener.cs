...
namespace Service.Net
{
    public class SocketListener
    {
        ...
        public delegate void ConnectedClientDelegate(Socket clientSocket, object token);
        public ConnectedClientDelegate ConnectedClientCallback;


        public SocketListener()
        {
            ConnectedClientCallback = null;
        ...
        private void OnAcceptCompleted(object sender, SocketAsyncEventArgs e)
        {
            if (e.SocketError == SocketError.Success)
            {
                ...
                if (ConnectedClientCallback != null)
                {
                    ConnectedClientCallback(clientSocket, e.UserToken);
                }
