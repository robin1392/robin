...
public class SocketRecvEvent
{
    ...
    public void OnJoinCoopGameNotify(Peer peer, MsgJoinCoopGameNotify msg)
    {
        ...
        UnityUtil.Print(" join recv ", JsonConvert.SerializeObject(msg.CoopPlayerInfo), "white");
    ...
    {
        UnityUtil.Print("coop monster spawn Notify ", $"UID:{msg.PlayerUId}, DataID:{msg.SpawnMonster.DataId}, ATK:{msg.SpawnMonster.Atk}, HP:{msg.SpawnMonster.Hp}", "white");
        //
        if (InGameManager.Get() != null)
