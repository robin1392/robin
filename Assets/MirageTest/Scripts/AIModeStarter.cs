...
namespace MirageTest.Scripts
{
    public class AIModeStarter : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Server.MatchData.AddPlayerInfo("1", "a", 0,0, new DeckInfo(1001, 1002, 1003, 1004, 1005));
            Server.MatchData.AddPlayerInfo("2", "b", 0,0, new DeckInfo(1001, 1002, 1003, 1004, 1005));
