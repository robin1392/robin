...
public class ClientTester : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < 20; ++i)
        {
            ...
            client1.GetComponent<RWAthenticator>().LocalUserId = i.ToString();
            client1.GetComponent<RWAthenticator>().LocalNickName = i.ToString();
            ...
            var id = (i + 1).ToString();
            client2.GetComponent<RWAthenticator>().LocalUserId = id.ToString();
            client2.GetComponent<RWAthenticator>().LocalNickName = id.ToString();
