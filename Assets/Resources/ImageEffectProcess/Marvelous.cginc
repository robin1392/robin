...
#if defined(USE_REALTIME_SHADOWS) || (defined(USE_SPECULAR) && defined(USE_SPECULAR_PIXEL_SHADING))
...
#ifdef USE_REALTIME_SHADOWS
	fixed3 lightDirection = normalize(_WorldSpaceLightPos0.xyz);
	return lerp(1,SHADOW_ATTENUATION(v),dot(lightDirection,v.normal)>0);
#else
	return 1;
#endif
}
