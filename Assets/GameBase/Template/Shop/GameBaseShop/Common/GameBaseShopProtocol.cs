...
namespace Template.Shop.GameBaseShop.Common
{
    ...
    public class GameBaseShopProtocol : MessageControllerBase
    {
        ...
        public delegate (GameBaseShopErrorCode errorCode, int shopId, ShopProductInfo shopProductInfo, ShopProductInfo changeProductInfo, ItemBaseInfo payItemInfo, ItemBaseInfo[] arrayRewardItemInfo, QuestData[] arrayQuestData) ReceiveShopBuyReqDelegate(string accessToken, int shopId, int productId);
        ...
        public bool ReceiveShopBuyReq(ISender sender, byte[] msg, int length)
        {
            ...
            return ShopBuyAck(sender, res.errorCode, res.shopId, res.shopProductInfo, res.changeProductInfo, res.payItemInfo, res.arrayRewardItemInfo, res.arrayQuestData);
        }

        public bool ShopBuyAck(ISender sender, GameBaseShopErrorCode errorCode, int shopId, ShopProductInfo shopProductInfo, ShopProductInfo changeProductInfo, ItemBaseInfo payItemInfo, ItemBaseInfo[] arrayRewardItemInfo, QuestData[] arrayQuestData)
        {
            JObject json = new JObject();
            json.Add("errorCode", (int)errorCode);
            json.Add("shopId", shopId);
            json.Add("shopProductInfo", JsonConvert.SerializeObject(shopProductInfo));
            json.Add("changeProductInfo", JsonConvert.SerializeObject(changeProductInfo));
        ...
        public delegate bool ReceiveShopBuyAckDelegate(GameBaseShopErrorCode errorCode, int shopId, ShopProductInfo shopProductInfo, ShopProductInfo changeProductInfo, ItemBaseInfo payItemInfo, ItemBaseInfo[] arrayRewardItemInfo, QuestData[] arrayQuestData);
        ...
        public bool ReceiveShopBuyAck(ISender sender, byte[] msg, int length)
        {
            ...
            return ReceiveShopBuyAckHandler(errorCode, shopId, shopProductInfo, changeProductInfo, payItemInfo, arrayRewardItemInfo, arrayQuestData);
        }
        #endregion        
        ...
        public delegate (GameBaseShopErrorCode errorCode, int shopId, ShopProductInfo shopProductInfo, ShopProductInfo changeProductInfo, ItemBaseInfo payItemInfo, ItemBaseInfo[] arrayRewardItemInfo, QuestData[] arrayQuestData) ReceiveShopPurchaseReqDelegate(string accessToken, int shopId, int productId, string purchaseInfo);
        ...
        public bool ReceiveShopPurchaseReq(ISender sender, byte[] msg, int length)
        {
            ...
            return ShopPurchaseAck(sender, res.errorCode, res.shopId, res.shopProductInfo, res.changeProductInfo, res.payItemInfo, res.arrayRewardItemInfo, res.arrayQuestData);
        }

        public bool ShopPurchaseAck(ISender sender, GameBaseShopErrorCode errorCode, int shopId, ShopProductInfo shopProductInfo, ShopProductInfo changeProductInfo, ItemBaseInfo payItemInfo, ItemBaseInfo[] arrayRewardItemInfo, QuestData[] arrayQuestData)
        {
            JObject json = new JObject();
            json.Add("errorCode", (int)errorCode);
            json.Add("shopId", shopId);
        ...
        public delegate bool ReceiveShopPurchaseAckDelegate(GameBaseShopErrorCode errorCode, int shopId, ShopProductInfo shopProductInfo, ShopProductInfo changeProductInfo, ItemBaseInfo payItemInfo, ItemBaseInfo[] arrayRewardItemInfo, QuestData[] arrayQuestData);
        ...
        public bool ReceiveShopPurchaseAck(ISender sender, byte[] msg, int length)
        {
            ...
            ItemBaseInfo[] arrayRewardItemInfo = JsonConvert.DeserializeObject<ItemBaseInfo[]>(jObject["arrayRewardItemInfo"].ToString());
            QuestData[] arrayQuestData = JsonConvert.DeserializeObject<QuestData[]>(jObject["arrayQuestData"].ToString());
            return ReceiveShopPurchaseAckHandler(errorCode, shopId, shopProductInfo, changeProductInfo, payItemInfo, arrayRewardItemInfo, arrayQuestData);
        }
        #endregion        
