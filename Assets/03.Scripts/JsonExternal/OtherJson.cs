...
namespace Nev
{
	...
	public class JSONValue {
	    ...
	    public JSONValue(long longNumber)
	    {
		...
		public static implicit operator JSONValue(int integer) {
			return new JSONValue(integer);
		}

	    public static implicit operator JSONValue(long longNum)
	    {
	        return new JSONValue(longNum);
	    }
	...
	public class JSONObject : IEnumerable<KeyValuePair<string, JSONValue>> {
	    ...
	    public List<string> GetAllKeyList()
	    {
	        ...
	        List<string> AllkeyValue = new List<string>();
	        foreach(KeyValuePair<string, JSONValue> pair in values)
	        {
	            AllkeyValue.Add(pair.Key);
	        }
	        return AllkeyValue;
	    }
